...
return [
    ...
    'mail_driver' => [
        'driver' => 'Sending server',
        'driver_helper' => 'Mail server used for this plugin\'s emails. It does not affect the rest of the installation\'s emails.',
        'drivers' => [
            'default' => 'Botble default (installation SMTP)',
            'smtp' => 'Custom SMTP',
            'microsoft' => 'Microsoft account (OAuth / Graph API)',
        ],
        'smtp_host' => 'SMTP host',
        'smtp_port' => 'Port',
        ...
        'smtp_from_email_helper' => 'Optional. When empty, the installation\'s configured sender is used.',
        'smtp_from_name' => 'From name',
        'smtp_not_configured' => 'The custom SMTP server is not configured (host missing). Check Mailing → Settings.',
        'ms_tenant' => 'Tenant ID (Directory)',
        'ms_tenant_helper' => 'Entra ID directory (tenant) ID. Leave empty or use "common" to allow any corporate account.',
        'ms_client_id' => 'Client ID (Application ID)',
        'ms_client_secret' => 'Client Secret',
        'ms_client_secret_helper' => 'Secret value created in Azure → Certificates & secrets. It expires as configured in Azure.',
        'ms_save_credentials_first' => 'Enter and save the Tenant ID, Client ID and Client Secret; the connect button will then appear here.',
        'ms_not_configured' => 'The Microsoft connection is not configured (Azure app credentials missing). Check Mailing → Settings.',
        'ms_not_connected' => 'No Microsoft account is connected. Connect it in Mailing → Settings.',
        'ms_reconnect_required' => 'The Microsoft session has expired or been revoked. Reconnect the account in Mailing → Settings.',
        'connect' => 'Connect with Microsoft',
        'disconnect' => 'Disconnect',
        'disconnect_confirm' => 'Disconnect the Microsoft account? Sendings using this server will pause until you reconnect.',
        'disconnected' => 'Microsoft account disconnected.',
        'connected_as' => 'Connected as',
        'connected_success' => 'Microsoft account connected successfully (:email). Emails will be sent from that account.',
        'connect_cancelled' => 'The Microsoft connection was not completed: :error',
        'invalid_state' => 'The sign-in security verification is not valid. Please try again.',
        'connection_error_title' => 'The Microsoft connection has been lost. Please reconnect the account.',
        'redirect_uri_helper' => 'Register this redirect URL (Web type) in the Azure/Entra ID application:',
        'test_email_label' => 'Send test email',
        'test_email_helper' => 'Sends a test email using the selected server (save your settings changes first).',
        'test_email_button' => 'Send test',
        'test_subject' => 'Mailing plugin test email',
        'test_body' => 'This is a test email sent from the Mailing plugin to verify the sending server configuration.',
        'test_sent' => 'Test email sent to :email. Please check the inbox.',
    ],
